...
-- DELETE: protected by admin PIN check through edge function (service_role)
-- No direct DELETE policy for anon/authenticated — deletion goes through admin-delete-transaction edge function
